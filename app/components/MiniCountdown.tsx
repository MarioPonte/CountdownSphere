...
const Countdown: React.FC<CountdownProps> = ({ days, hours, minutes, seconds, message }) => {
    ...
    return (
        <div className="flex mt-10 select-none">
            <div className={`${days === 0 && "hidden"} w-14`}>
            ...
            <div className={`${(days === 0 && hours === 0) && "hidden"} w-14`}>
                <div className="text-2xl font-bold">
                    {hours}
                </div>
                <div className="text-[8px] uppercase tracking-wide">
            ...
            <div className={`${(days === 0 && hours === 0 && minutes === 0) && "hidden"} w-14`}>
                <div className="text-2xl font-bold">
                    {minutes}
                </div>
                <div className="text-[8px] uppercase tracking-wide">
            ...
            <div className={`${(days === 0 && hours === 0 && minutes === 0 && seconds === 0) && "hidden"} w-14`}>
                <div className="text-2xl font-bold">
                    {seconds}
                </div>
                <div className="text-[8px] uppercase tracking-wide">
